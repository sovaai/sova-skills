...
|№|Skill name|Languages|Category|Description
|---|---|---|---|---|
|13|Orders with verbs (movements and gestures)|- [RU](https://github.com/sovaai/sova-skills/tree/main/Skills/RU/SOVA_Rus_Orders)<br>- [EN](https://github.com/sovaai/sova-skills/tree/main/Skills/EN/SOVA_Rus_Orders)|Orders|The skill contains templates and dictionaries with various commands indicating movement or gestures, like, jump, dance, etc. It is not a full-fledged skill. You can use parts of the skill when creating your virtual assistant.|
